...
type Props = { mode: ThemeMode; themePreference: Preference; onThemeChange: (value: Preference) => void }
const pageInfo: Record<string, { title: string; group: string; description: string }> = {
...
export default function DesignSystem({mode,themePreference,onThemeChange}:Props) {
